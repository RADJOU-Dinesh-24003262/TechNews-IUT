...
date = '2026-01-27'
draft = false
title = "Projets de cybersécurité 2026"
author = "Groupe Projets cyber (Imran Guzelbaba et Loïc Hernandez)"
authorimage = "images/global/author.webp"
tags = ["Projets", "Cyber", "IUT", "Informatique", "Étudiant", "Tech", "Crypto", "Site"]
summary = "Découvrez les projets réalisés par les étudiants en BUT Informatique à l'IUT d'Aix-en-Provence sur la cybersécurité et cryptographie"
categories = ["Étudiant", "Cyber", "Site", "Projets", "Blog"]
featured_image = "images/article-jounees-cybersecurite.png"
+++

  

# Projet AmUsec & Cybercigales

  

*Avant de partir en stage, les étudiants de deuxième année auront l’occasion de participer à quelques journées d’échange et d’apprentissage centrés sur la cybersécurité, animés par des professionnels expérimentés.  
Découvrez également les projets d’étudiants qui seront présentés au campus de Luminy à l’occasion.*

  

## 18 Mars - *CyberCigales*

  

***Cybercigales*** est un projet de **“cyber escape-game”** en collaboration avec *Les Cigales*, basé sur des sites remplis d’énigmes sur la cryptographie et la cybersécurité.

*Les Cigales* est une école basée au sein du campus de Luminy, qui organise des semaines d’activités en pension complète pour des lycéennes motivées qui souhaitent s’intéresser aux **Mathématiques** et à l’**Informatique**, avec l’aide de professeurs et chercheurs qualifiés.
...
**Deux différents groupes de 5 étudiants de deuxième année ont été chargés de cette mission** pour créer des sites interactifs, accessibles et éducatifs.

  

![Image Site [CyberCigales.fr](http://cybercigales.fr)](/TechNews-IUT/images/article-jounees-cybersecurite/cybercigales.png)

  

Le site [CyberCigales](https://benahmed.alwaysdata.net) présente aux étudiantes un grand nombre de **formations interactives**, du chiffrage aux grandes notions de la sécurité des informations personnelles. Il sensibilise les jeunes lycéennes à la fois aux sciences derrière le monde semblant abstrait de l’informatique, pour éventuellement **éveiller leur curiosité et intérêt** à ces domaines, mais également aux **failles et dangers** dont tout le monde se devrait de connaître et comprendre dans notre monde actuel.
...
![Image Site EscapeTheCode](/TechNews-IUT/images/article-jounees-cybersecurite/escape.png)
...
Les deux jours suivants seront alors dédiés à l’***AMUSEC***, événement ouvert aux étudiants d’informatique de deuxième année pour **approfondir leurs compétences en cybersécurité** dans un contexte bien plus **interactif** et adjacent à la **réalité professionnelle**.

  

Pendant deux journées, les étudiants sont conviés au *Campus de Luminy* pour assister à de multiples conférences concernant les différentes **problématiques et actualités pertinentes de la cybersécurité**. Sont également invités d’autres étudiants de divers domaines et divers endroits dans la région, et des maîtres de conférences d’entièrement autres régions.

  

Ces journées présentent une grande opportunité pour acquérir des connaissances concrètes auprès de **professionnels expérimentés, certifiés et grandement reconnus**. Seront invités des entreprises majeures telles qu’*Orange*, de grandes écoles comme *Polytech*, et d’importants chercheurs renommés.
